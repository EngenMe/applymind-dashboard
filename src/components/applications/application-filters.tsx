...
/**
 * Six controls, laid out three ways.
 *
 * On a phone: search full width, then the four narrow controls two-up, which
 * keeps each one wide enough to actually read its selected value. On a tablet:
 * four across. On a laptop: a single row, as before.
 *
 * The date inputs previously carried a fixed 9.5rem width, which is fine in a
 * row and overflows a 320px screen once two sit side by side. They are fluid
 * now and constrained only at the top end.
 */
  ...
  return (
      <div className="border-b border-rule pb-4">
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-4 lg:flex lg:items-end">
          <div className="col-span-2 sm:col-span-4 lg:max-w-xs lg:flex-1">
          ...
          <div className="col-span-2 sm:col-span-2 lg:w-52">
          ...
          <div>
            ...
            <Input
                id="application-from"
                type="date"
                className="mt-1.5 w-full lg:w-[9.5rem]"
                value={filters.from}
          ...
          {hasActiveFilters(filters) ? (
              <Button
                  variant="ghost"
                  size="sm"
                  className="col-span-2 justify-self-start sm:col-span-2 lg:self-auto"
